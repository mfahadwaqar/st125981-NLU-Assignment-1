...
### Example Similar Words Output

Below are real examples from the trained Skipgram (Negative Sampling) model showing similar words:
...
**Analogy: buy:bought :: sell:?**
- pacific (similarity: 0.3623)
- recent (similarity: 0.3297)
- compete (similarity: 0.3284)
